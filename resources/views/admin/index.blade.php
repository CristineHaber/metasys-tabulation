<x-layout>
    ...
    <div class="row">
        <div class="col-lg-4">
            <div class="row">
                <div class="col-lg-12">
                    <!-- Apply a light gradient to the card -->
                    <a href="{{ route('admin.events.create') }}" class="card overflow-hidden"
                        style="background: linear-gradient(to bottom, #f2f2f2, #e0e0e0);">
                        <div class="card-body p-4">
                            ...
                            <span class="mt-2 h5">CREATE EVENT</span>
                        </div>
                    </a>
                </div>
            </div>
        ...
        <div class="col-lg-4">
            <div class="row">
                <div class="col-lg-12">
                    <!-- Apply a light gradient to the card -->
                    <a href="{{ route('admin.events.index') }}" class="card overflow-hidden"
                        style="background: linear-gradient(to bottom, #fff7e6, #ffe9cc);">
                        <div class="card-body p-4">
                            <svg xmlns="http://www.w3.org/2000/svg" height="2em"
                            ...
                            <span class="mt-2 h5">VIEW EVENTS - {{ $eventCount}}</span>
                        </div>
                    </a>
                </div>
            </div>
